...
Route::get('/radicadopqr/getDatosById', [RadicadoPQRController::class, 'getDataById']);
...
Route::get('/proyecto/getDatosById', [ProyectoController::class, 'getDataById']);
...
Route::get('/respuestapqr/getDatosById', [RespuestaPQRController::class, 'getDataById']);
...
Route::get('/arearespuesta/getDatosById', [AreaRespuestaController::class, 'getDataById']);
...
Route::get('/cliente/getDatosById', [clienteController::class, 'getDataById']);
...
Route::get('/barrio/getDatosById', [BarrioController::class, 'getDataById']);
...
Route::get('/tiposolicitud/getDatosById', [TipoSolicitudController::class, 'getDataById']);
